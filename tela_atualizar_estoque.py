...
from control.controle_estoque import exibir_produtos, atualizar_qtd_produto
...
class AtualizarProduto:
    ...
    def __init__(self, master):
        ...
        janela.title('Atualizar quantidade de Produto')
        janela_largura = 470
        janela_altura = 110
        ...
        self.ccbox_produtos = ttk.Combobox(janela, state='readonly',
        postcommand=self.exibir_produtos)
        self.ccbox_produtos.place(x=75, y=20, width=165)

        # adicionando buttons ao tela
        btn_cadastrar = Button(janela, image=img_cadastro, text='Atualizar',
    ...
    def exibir_produtos(self):
        ...
        # passar os dados para a ccbox produtos
        self.ccbox_produtos.configure(values=lista_produtos)
    ...
    def pegar_informacoes_campos(self):
        ...
        atualizar_qtd_produto(self.ccbox_produtos.get(), self.txt_prod_qtd.get())
